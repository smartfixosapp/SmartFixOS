...
const DEFAULT_ORDER_STATUSES = [
  ...
  {
    id: "part_arrived_waiting_device",
    label: "Pieza lista / Esperando cliente",
    order: 7,
    colorClass: "bg-yellow-400/20 text-yellow-200 border-yellow-400/30",
    colorClasses: "bg-yellow-400/20 text-yellow-200 border-yellow-400/30",
    color: "#FACC15",
    isActive: true,
    isTerminal: false
  },
