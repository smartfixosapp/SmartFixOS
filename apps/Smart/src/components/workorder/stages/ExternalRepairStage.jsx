    ...
    <div className="space-y-6">
        ...
        <div className="relative z-10 grid gap-5 xl:grid-cols-[1.2fr_0.8fr] xl:items-start">
          <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-2">
              <Badge className="rounded-full border border-fuchsia-400/30 bg-fuchsia-500/10 px-3 py-1 text-[11px] font-semibold tracking-[0.25em] text-fuchsia-200">
                Reparacion externa
              </Badge>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-end gap-x-4 gap-y-2">
                <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">Servicio Fuera del Taller</h2>
            ...
            <div className="grid gap-3 md:grid-cols-3">
              ...
              <div className="rounded-[22px] border border-white/10 bg-black/25 p-4 backdrop-blur-md">
                <p className="mb-1 text-[11px] font-semibold tracking-[0.24em] text-white/35">Taller asignado</p>
                <p className="truncate text-sm font-semibold text-white/75">{o.external_shop || "Sin asignar"}</p>
              </div>
              <div className="rounded-[22px] border border-white/10 bg-black/25 p-4 backdrop-blur-md">
                <p className="mb-1 text-[11px] font-semibold tracking-[0.24em] text-white/35">Orden</p>
            ...
            <div className="relative z-10 border-b border-white/10 px-5 py-4">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[11px] font-semibold tracking-[0.28em] text-white/35">Cobro y trazabilidad</p>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <section className="overflow-hidden rounded-[28px] border border-fuchsia-500/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] shadow-[0_18px_50px_rgba(0,0,0,0.28)]">
          ...
          <div className="grid gap-4 p-5 md:grid-cols-2">
            <div className="rounded-[22px] border border-white/8 bg-black/20 p-5">
              <p className="mb-2 text-[11px] font-bold tracking-[0.28em] text-white/35">Taller</p>
              <p className="text-2xl font-semibold tracking-tight text-white">{o.external_shop || "—"}</p>
            </div>
            <div className="rounded-[22px] border border-white/8 bg-black/20 p-5">
              <p className="mb-2 text-[11px] font-bold tracking-[0.28em] text-white/35">Contacto / referencia</p>
        ...
        <section className="overflow-hidden rounded-[28px] border border-orange-500/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] shadow-[0_18px_50px_rgba(0,0,0,0.28)]">
          ...
          <div className="p-5">
            <div className="rounded-[22px] border border-white/8 bg-black/20 p-5">
              <p className="mb-2 text-[11px] font-bold tracking-[0.28em] text-white/35">Descripcion</p>
