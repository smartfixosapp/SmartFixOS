...
import {
  ...
  Clock, SlidersHorizontal, ChevronLeft, ChevronRight, Sparkles, Brain, ImagePlus, Mic, MicOff
} from "lucide-react";
...
export default function WorkOrderWizard({ open, onClose, onSuccess, preloadedCustomer, startWithJenai = false }) {
  ...
  const [jenaiSubMode, setJenaiSubMode] = useState("normal"); // "quick" | "normal" — default normal, toggle available
  const [jenaiQuickToggle, setJenaiQuickToggle] = useState(false); // small toggle in JENAI screen
                ...
                <div className="space-y-4 relative z-10">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-[9px] font-semibold px-2.5 py-1 rounded-full ${
                      ...
                      {jenaiConfirm.is_quick_order ? "Rapida" : "Regular"}
                    </span>
                  </div>
