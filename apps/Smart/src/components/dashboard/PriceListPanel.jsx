...
export default function PriceListPanel() {
  ...
  return (
    <Card className="bg-black/40 backdrop-blur-3xl border border-white/5 rounded-[24px] shadow-2xl relative overflow-hidden">
          ...
          <div className="max-h-96 overflow-y-auto space-y-2 pr-2 custom-scrollbar">
            {filteredItems.map((item) => (
              <div
                ...
                className="p-3 bg-white/5 border border-white/5 rounded-[16px] hover:bg-white/10 transition-all"
              >
