    ...
    <div className="apple-type space-y-6">
      <div className="p-4 bg-apple-red/12 rounded-apple-md">
        <div className="flex gap-3">
          <AlertTriangle className="w-5 h-5 text-apple-red flex-shrink-0" />
          <div className="apple-text-subheadline text-apple-red">
            <p className="apple-text-headline mb-1">Configuración Avanzada</p>
      ...
      <Card className="apple-card border-0">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label className="apple-label-secondary apple-text-footnote">Duración de caché (segundos)</Label>
            <Input
              type="number"
              min="30"
              max="600"
            ...
            />
            <p className="apple-text-caption1 apple-label-tertiary">Tiempo que se guardan datos en memoria (30-600 seg)</p>
          </div>

          <div className="space-y-2">
            <Label className="apple-label-secondary apple-text-footnote">Límite de tasa API (requests/min)</Label>
            <Input
              type="number"
              min="10"
              max="1000"
      ...
      <Card className="apple-card border-0">
        <CardHeader>
          <CardTitle className="apple-text-title3 apple-label-primary flex items-center gap-2">
            <Database className="w-5 h-5 text-apple-red" />
            Sistema
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label className="apple-label-secondary apple-text-footnote">Tamaño máximo de archivo (MB)</Label>
            <Input
              type="number"
              min="1"
              max="100"
          ...
          <div className="space-y-2">
            <Label className="apple-label-secondary apple-text-footnote">Timeout de sesión (minutos)</Label>
            <Input
              type="number"
              min="30"
              max="1440"
          ...
          <div className="flex items-center justify-between p-3 bg-gray-sys6 dark:bg-gray-sys5 rounded-apple-md">
            <div>
              <Label className="apple-label-primary apple-text-body">Modo debug</Label>
              <p className="apple-text-caption1 apple-label-tertiary">Mostrar logs en consola</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between p-3 bg-gray-sys6 dark:bg-gray-sys5 rounded-apple-md">
            <div>
              <Label className="apple-label-primary apple-text-body">Analytics</Label>
              <p className="apple-text-caption1 apple-label-tertiary">Recopilar datos de uso</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between p-3 bg-gray-sys6 dark:bg-gray-sys5 rounded-apple-md">
            <div>
              <Label className="apple-label-primary apple-text-body">Reporte de errores</Label>
              <p className="apple-text-caption1 apple-label-tertiary">Enviar errores automáticamente</p>
            </div>
            <Switch
      ...
      <Card className="apple-card border-0">
        ...
        <CardContent>
          <div className="flex items-center justify-between p-4 bg-apple-red/12 rounded-apple-md">
            <div>
              <Label className="apple-label-primary apple-text-body">Modo mantenimiento</Label>
              <p className="apple-text-caption1 apple-label-tertiary">Deshabilitar acceso para usuarios (solo admins)</p>
            </div>
            <Switch
              checked={data.maintenance_mode}
              onCheckedChange={(v) => {
                if (v && !confirm("Esto deshabilitará el acceso para todos los usuarios excepto admins. ¿Continuar?")) return;
