...
const OrderRow = memo(function OrderRow({ order, onClick }) {
  ...
  const isQuickOrder = status_metadata?.quick_order === true;
  ...
  return (
    ...
    >
      <Card
        ...
        className={`p-4 sm:p-6 cursor-pointer transition-all duration-300 bg-gradient-to-br from-gray-900 to-black border-gray-800 hover:border-red-500/50 hover:shadow-xl hover:shadow-red-600/20 focus:outline-none focus:ring-2 focus:ring-red-600/40 ${
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
            ...
            <div className="space-y-2 min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {isQuickOrder && (
                  <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30 text-xs" variant="outline">
                    Rápida
                  </Badge>
                )}
                ...
                {/* Garantía - Badge permanente */}
                <WarrantyBadge passed_warranty={passed_warranty} />
              </div>
