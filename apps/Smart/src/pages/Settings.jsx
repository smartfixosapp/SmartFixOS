...
import {
  ...
  Phone, MessageCircle, MapPin, Facebook, Instagram, Star, Landmark
} from "lucide-react";
            ...
            <div className="space-y-5">
              ...
              <div className="bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 relative overflow-hidden">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-white/60 text-xs font-semibold ml-1 flex items-center gap-1.5"><MapPin className="w-3.5 h-3.5" /> Dirección Física</label>
              ...
              <div className="bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 relative overflow-hidden">
                ...
                <div className="space-y-4 relative z-10">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-white/60 text-xs font-semibold ml-1 flex items-center gap-1.5"><Facebook className="w-3.5 h-3.5" /> Facebook</label>
