...
// JenaiExpenseCapture (scan-recibo IA general) removido — el flujo de IA
// solo aplica a Órdenes de Compra ahora.
...
Maximo 150 palabras. Texto plano, sin markdown.`
  ...
  return (
    <div className="apple-surface apple-type">
      {/* ── Header sticky — se queda fijo arriba mientras el usuario scrollea ── */}
      <div
