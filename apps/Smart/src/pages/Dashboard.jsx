        ...
        <div className="max-w-[2560px] mx-auto w-full flex-1 min-h-0 flex flex-col">
          ...
          <div className="hidden md:flex md:flex-row md:flex-1 md:min-h-0 bg-[#121215]/40 backdrop-blur-[40px] border border-white/10 rounded-[40px] shadow-[0_32px_80px_rgba(0,0,0,0.45)] relative overflow-hidden">
            ...
            <div className="relative z-10 w-[260px] xl:w-[300px] shrink-0 flex flex-col gap-3 p-6 lg:p-7 border-r border-white/[0.07]">
              ...
              {/* Accesos rápidos */}
              <button onClick={() => { setShowWorkOrderWizard(true); setShowJenaiWizard(false); }} className="flex-1 min-h-[44px] bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-center gap-3 px-4 hover:bg-blue-500/15 active:scale-95 transition-all">
          ...
          <div className="md:hidden flex flex-col flex-1 min-h-0 gap-3">
            ...
            <div className="grid grid-cols-3 gap-2 px-1 pb-2 shrink-0">
              ...
              <button onClick={() => { setShowPriceList(true); setPriceListSearch(""); }} className="flex flex-col items-center justify-center gap-1.5 py-3 bg-violet-500/10 border border-violet-500/20 rounded-[20px] active:scale-95 transition-all">
                <Search className="w-5 h-5 text-violet-400" />
                <span className="text-[9px] font-black text-violet-400/80 uppercase tracking-tight">Precios</span>
              </button>
            </div>
          </div>
