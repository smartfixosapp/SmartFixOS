        ...
        <div className="max-w-[2560px] mx-auto w-full flex-1 min-h-0 flex flex-col">
          ...
          <div className="md:hidden flex flex-col flex-1 min-h-0 gap-3">
            ...
            <div className="grid grid-cols-2 gap-2 px-1 pb-2 shrink-0">
              <button onClick={() => setShowWorkOrderWizard(true)} className="flex flex-col items-center justify-center gap-1.5 py-4 bg-violet-500/10 border border-violet-500/20 rounded-[20px] active:scale-95 transition-all">
                <Sparkles className="w-5 h-5 text-violet-400" />
                <span className="text-[9px] font-black text-violet-400/80 uppercase tracking-tight">Nueva Orden</span>
