  ...
  const integrationsModule = {
    Core: {
      ...
      UploadFile: async ({ file }) => {
        ...
        // Sanitize filename for storage key: Supabase rejects special/non-ASCII characters
        const safeName = (file.name || "file").replace(/[^a-zA-Z0-9._-]/g, "_").replace(/_+/g, "_") || "file";
